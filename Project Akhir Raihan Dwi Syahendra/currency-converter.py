...
# Variable Data Rate Currency
url = "https://www.x-rates.com/table/?from=IDR&amount=1"

# Header Mozila untuk Windows10
header = {
...
class Convert:
    ...
    def __init__(self, root):
        ...
        self.IDR = Scale(Frame_1, variable = var2, from_ = 0, to = 1000, length = 500, tickinterval = 50, orient = VERTICAL, bg = '#EA2A97', label = "IDR", font = ('arial', 10, 'bold'))
        self.IDR.grid(row = 0, column = 0, rowspan = 2)

        #=========================== Labels for Frame_2 Top=======================

        self.lbl_IDR = Label(Frame_2Top, font = ('arial', 20, 'bold'), text = "IDR", padx = 2, pady = 10, width = 19, bd = 2)
        self.lbl_IDR.grid(row = 1, column = 0)
